...
if showByCategory
    ...
    fprintf("Covered \t\t\t"); fprintf("%.1f%%\t",(statistics.covered_signs(end)./statistics.total_signs(end))*100); fprintf("\n");
    fprintf("Partially covered\t"); fprintf("%.1f%%\t",(statistics.partially_covered_signs(end)./statistics.total_signs(end))*100); fprintf("\n");
    fprintf("Not covered\t\t\t"); fprintf("%.1f%%\t",((statistics.total_signs(end)-statistics.partially_covered_signs(end)-statistics.covered_signs(end))./statistics.total_signs(end))*100); fprintf("\n");
    fprintf("Covered area\t\t"); fprintf("%.1f%%\t",(statistics.covered_area(end)./statistics.total_area(end))*100); fprintf("\n");
